export const startScanResponse = {
    status: 200,
    headers: {
...
export const scanStatusRunning = {
    'status': 200,
    'data': {
      "status": "RUNNING"
    }
...
export const scanStatusComplete = {
    'status': 200,
    'data': {
      "status": "COMPLETE"
      }
...
export const startScanOutput = "9a0b6a25-f05h-4c76-b9db-797x8bb4fb00";

export const getNextInput = {
    "links" : [ {
        "rel" : "first",
...
export const getNextOutput = "https://us.api.insight.rapid7.com:443/ias/v1/search?index=1&size=2";

export const scanVulnsPg1 = {"status": 200, "data": {
    "data": [
        {
            "severity": "MEDIUM",
...
export const scanVulnsPg2 = {"status": 200, "data": {
    "data": [
        {
            "severity": "INFORMATIONAL"
        },
